...
export const skillCategories = [
  {
    ...
    skills: [
      ...
      { name: "JavaScript", level: 96, icon: "/assets/javascript.svg" },
      { name: "HTML", level: 96, icon: "/assets/html5.svg" },
      { name: "CSS", level: 94, icon: "/assets/css3.svg" },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "Express.js", level: 78, icon: "/assets/express.svg" },
      { name: "FastAPI", level: 84, icon: "/assets/fastapi.png" },
      { name: "REST APIs", level: 88, icon: "/assets/restapi.png" },
      { name: "GraphQL", level: 65, icon: "/assets/graphql.svg" },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "TensorFlow", level: 68, icon: "/assets/tensorflow.svg" },
      { name: "Playwright", level: 80, icon: "/assets/playwright.svg" },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "Firebase", level: 74, icon: "/assets/firebase.svg" },
      { name: "SQLite", level: 76, icon: "/assets/sqlite.svg" },
    ],
  },
  {
    label: "DevOps & Tools",
    ...
    skills: [
      ...
      { name: "Git", level: 90, icon: "/assets/git.svg" },
      { name: "GitHub", level: 90, icon: "/assets/github.png" },
      { name: "GitHub Actions", level: 92, icon: "/assets/githubaction.png" },
      { name: "Linux", level: 82, icon: "/assets/linux.svg" },
      { name: "Bash", level: 78, icon: "/assets/bash.svg" },
